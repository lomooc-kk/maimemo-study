...
2. **写记忆材料**：把这些词写成一篇短文，文中目标词加粗，每段后面跟中文译文和该段生词（带词性、美式音标和 1–3 个常用义项）。风格以「读得进去」为先：句子短、有梗概、有主线；**体裁和场景每篇轮换**（见 `references/style-log.md`），优先编进你自己熟悉的场景，不重复上一篇的样子。**难度分简单 / 中等 / 困难三档**，写作前会先问你选哪一档，不问就按中等写。
