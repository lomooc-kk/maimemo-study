...
2. **每段后面紧跟该段的中文译文和该段用到的生词**，顺序是：英文段落 → 中文译文 → 生词清单。生词按在段内出现的先后排，条目写成 `单词 词性 /美式音标/ 释义`，例如 `cottage n. /ˈkɑːtɪdʒ/ 小屋；村舍`、`plumb v./n. /plʌm/ 探测深度；垂直的；铅锤`。这样读一段就能立刻对照译文、顺手过一遍词，比把词表堆在文末好用。
